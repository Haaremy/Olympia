...
function gameSettings() {
    return __awaiter(this, void 0, void 0, function () {
        var gameSettings_1, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, 3, 5]);
                    return [4 /*yield*/, prisma.gameSettings.create({
                            data: {
                ...
                case 1:
                    gameSettings_1 = _a.sent();
                    return [3 /*break*/, 5];
                case 2:
                    error_1 = _a.sent();
                    console.error("Error creating game settings:", error_1);
                    return [3 /*break*/, 5];
                case 3: return [4 /*yield*/, prisma.$disconnect()];
                case 4:
                    _a.sent(); // Disconnect the Prisma client when done
                    return [7 /*endfinally*/];
